...
describe Ecommerce::Resources::Collection do
  ...
  describe '#build' do
    ...
    it 'returns Ecommerce::Resources::Collection object' do
      expect(subject.build.class).to eq(Ecommerce::Resources::Collection)
    end
  end
